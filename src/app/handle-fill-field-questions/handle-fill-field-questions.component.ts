...
export class HandleFillFieldQuestionsComponent implements OnInit {
  ...
  info() {
    Swal.fire(
      '',
      'Οι "Ερωτήσεις Συμπλήρωσης-κενού" αποσκοπούν στην εξάσκηση των Εκπαιδευομένων.Ομαδοποιούνται με βάση τις SQL δεσμευμένες λέξεις από το πεδίο "Αποκρυμμένες Λέξεις" του πίνακα και εμφανίζονται στην κατηγορία "Εξάσκηση σε Ερωτήσεις Συμπλήρωσης-Κενού".',
      'info'
    );
  }
}
